...
A collection of small, focused Data Science projects.
Each project solves one real problem cleanly.
...
| Project | Topic | Tools |
|---|---|---|
| 01 - Number Guesser | Python logic and loops | Python |
| 02 - Word Frequency Counter | NLP basics | Python, Collections |
